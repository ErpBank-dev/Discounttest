...
class PurchaseRequestLineMakePurchaseOrder(models.TransientModel):
    ...
    def _prepare_purchase_order(self, picking_type, group_id, company, origin):
        if not self.supplier_id and not self.is_agreement:
    ...
    def _get_purchase_line_onchange_fields(self):
        if self.is_agreement:
            return ["product_uom_id", "display_name"]
        else:
    ...
    def make_purchase_order(self):
        ...
        for item in self.item_ids:
            ...
            if available_po_lines and not item.keep_description:
                ...
                print('dddddddddrtyyyyyyyyyyyyyddddddddddddddd',po_line_data)
            ...
            po_line.price_unit=item.line_id.estimated_cost
    ...
    def make_agreement(self):
        ...
        # request = self.env['purchase.request'].browse(active_ids)
        # po_data = self._prepare_purchase_order(
