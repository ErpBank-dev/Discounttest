...
class PurchaseRequestLine(models.Model):
    ...
    requisition_lines = fields.Many2many(
        ...
        relation="requisition_request_purchase_order_line_rel",
        column1="requisition_request_line_id",
        column2="requisition_order_line_id",
        string="requisition Order Lines",
        readonly=True,
        copy=False,
    )
    ...
    def _compute_estimated_cost(self):
        for line in self:
            line.total_estimated_cost =line.estimated_cost * line.product_qty
